...
var Bicycle_1 = require("../vehicle/Bicycle");
var BicycleFactory = /** @class */ (function (_super) {
    __extends(BicycleFactory, _super);
    function BicycleFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BicycleFactory.prototype.getVehicle = function (vehicleName) {
        return new Bicycle_1.Bicycle(vehicleName);
    };
    return BicycleFactory;
}(vehicle_factory_1.VehicleFactory));
